  ...
  return (
    <div className="text-[#1f1f1f] sm:p-[5%] sm:pb-[2%] px-8 py-4 font-nunito flex flex-col w-full h-60 justify-start items-center rounded-[2.5rem] border border-gray-300 hover:border-[#9742FF] shadow-indigo-500/50 shadow-md">
      ...
      >
        <button
          type="button"
          className="flex justify-center items-center max-sm:w-44 max-sm:h-11 max-sm:text-16 text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-normal rounded-lg text-16 px-5 py-2 text-center mr-2 mb-2"
        >
          Leia mais
        </button>
      </Link>
